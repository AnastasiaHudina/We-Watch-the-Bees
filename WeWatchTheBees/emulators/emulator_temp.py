...
SENSOR_TYPE = "temp"
NORMAL_MIN, NORMAL_MAX = 28.0, 35.0
MAX_DELTA = 0.3          # максимальное изменение за 30 секунд
ANOMALY_PROB = 0.05      # 5% шанс начать аномалию
ANOMALY_STEPS = 5        # длительность аномалии (циклов)
ANOMALY_COLD_TARGET = 18.0
ANOMALY_HOT_TARGET = 42.0
    ...
    def update_value(self, device_id):
        ...
        if random.random() < ANOMALY_PROB:
            ...
            if random.random() < 0.5:
                target = ANOMALY_COLD_TARGET
            else:
                target = ANOMALY_HOT_TARGET
